...
// NewBillingServiceListBillingsParams creates a new BillingServiceListBillingsParams object,
...
func NewBillingServiceListBillingsParams() *BillingServiceListBillingsParams {
	return &BillingServiceListBillingsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewBillingServiceListBillingsParamsWithTimeout creates a new BillingServiceListBillingsParams object
...
// NewBillingServiceListBillingsParamsWithContext creates a new BillingServiceListBillingsParams object
...
// NewBillingServiceListBillingsParamsWithHTTPClient creates a new BillingServiceListBillingsParams object
...
func (o *BillingServiceListBillingsParams) WithDefaults() *BillingServiceListBillingsParams {
	o.SetDefaults()
	return o
}
...
func (o *BillingServiceListBillingsParams) WithTimeout(timeout time.Duration) *BillingServiceListBillingsParams {
...
func (o *BillingServiceListBillingsParams) WithContext(ctx context.Context) *BillingServiceListBillingsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the billing service list billings params
func (o *BillingServiceListBillingsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the billing service list billings params
func (o *BillingServiceListBillingsParams) WithHTTPClient(client *http.Client) *BillingServiceListBillingsParams {
...
func (o *BillingServiceListBillingsParams) WithBody(body *models.V1ListBillingsRequest) *BillingServiceListBillingsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the billing service list billings params
func (o *BillingServiceListBillingsParams) SetBody(body *models.V1ListBillingsRequest) {
	o.Body = body
}

// WriteToRequest writes these params to a swagger request
func (o *BillingServiceListBillingsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
