...
// NewProviderServiceGetProviderParams creates a new ProviderServiceGetProviderParams object,
...
func NewProviderServiceGetProviderParams() *ProviderServiceGetProviderParams {
	return &ProviderServiceGetProviderParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewProviderServiceGetProviderParamsWithTimeout creates a new ProviderServiceGetProviderParams object
...
// NewProviderServiceGetProviderParamsWithContext creates a new ProviderServiceGetProviderParams object
...
// NewProviderServiceGetProviderParamsWithHTTPClient creates a new ProviderServiceGetProviderParams object
...
func (o *ProviderServiceGetProviderParams) WithDefaults() *ProviderServiceGetProviderParams {
	o.SetDefaults()
	return o
}
...
func (o *ProviderServiceGetProviderParams) WithTimeout(timeout time.Duration) *ProviderServiceGetProviderParams {
...
func (o *ProviderServiceGetProviderParams) WithContext(ctx context.Context) *ProviderServiceGetProviderParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the provider service get provider params
func (o *ProviderServiceGetProviderParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the provider service get provider params
func (o *ProviderServiceGetProviderParams) WithHTTPClient(client *http.Client) *ProviderServiceGetProviderParams {
...
func (o *ProviderServiceGetProviderParams) WithBody(body models.V1GetProviderRequest) *ProviderServiceGetProviderParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the provider service get provider params
func (o *ProviderServiceGetProviderParams) SetBody(body models.V1GetProviderRequest) {
	o.Body = body
}

// WriteToRequest writes these params to a swagger request
func (o *ProviderServiceGetProviderParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
