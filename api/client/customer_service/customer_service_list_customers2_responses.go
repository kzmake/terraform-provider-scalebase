...
func (o *CustomerServiceListCustomers2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCustomerServiceListCustomers2OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewCustomerServiceListCustomers2Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewCustomerServiceListCustomers2OK() *CustomerServiceListCustomers2OK {
	return &CustomerServiceListCustomers2OK{}
}
...
func (o *CustomerServiceListCustomers2OK) Error() string {
	return fmt.Sprintf("[GET /v1/customer/list][%d] customerServiceListCustomers2OK  %+v", 200, o.Payload)
}
...
func (o *CustomerServiceListCustomers2OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCustomerServiceListCustomers2Default(code int) *CustomerServiceListCustomers2Default {
	return &CustomerServiceListCustomers2Default{
		_statusCode: code,
	}
}
...
func (o *CustomerServiceListCustomers2Default) Error() string {
	return fmt.Sprintf("[GET /v1/customer/list][%d] CustomerService_ListCustomers2 default  %+v", o._statusCode, o.Payload)
}
...
func (o *CustomerServiceListCustomers2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
