...
func (o *CustomerStaffServiceGetCustomerStaff2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCustomerStaffServiceGetCustomerStaff2OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewCustomerStaffServiceGetCustomerStaff2Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewCustomerStaffServiceGetCustomerStaff2OK() *CustomerStaffServiceGetCustomerStaff2OK {
	return &CustomerStaffServiceGetCustomerStaff2OK{}
}
...
func (o *CustomerStaffServiceGetCustomerStaff2OK) Error() string {
	return fmt.Sprintf("[GET /v1/customerstaff/get][%d] customerStaffServiceGetCustomerStaff2OK  %+v", 200, o.Payload)
}
...
func (o *CustomerStaffServiceGetCustomerStaff2OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCustomerStaffServiceGetCustomerStaff2Default(code int) *CustomerStaffServiceGetCustomerStaff2Default {
	return &CustomerStaffServiceGetCustomerStaff2Default{
		_statusCode: code,
	}
}
...
func (o *CustomerStaffServiceGetCustomerStaff2Default) Error() string {
	return fmt.Sprintf("[GET /v1/customerstaff/get][%d] CustomerStaffService_GetCustomerStaff2 default  %+v", o._statusCode, o.Payload)
}
...
func (o *CustomerStaffServiceGetCustomerStaff2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
