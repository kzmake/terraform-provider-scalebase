...
func (o *ProductServiceGetProductReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewProductServiceGetProductOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewProductServiceGetProductDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewProductServiceGetProductOK() *ProductServiceGetProductOK {
	return &ProductServiceGetProductOK{}
}
...
func (o *ProductServiceGetProductOK) Error() string {
	return fmt.Sprintf("[POST /v1/product/get][%d] productServiceGetProductOK  %+v", 200, o.Payload)
}
...
func (o *ProductServiceGetProductOK) GetPayload() *models.V1GetProductResponse {
	return o.Payload
}

func (o *ProductServiceGetProductOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewProductServiceGetProductDefault(code int) *ProductServiceGetProductDefault {
	return &ProductServiceGetProductDefault{
		_statusCode: code,
	}
}
...
func (o *ProductServiceGetProductDefault) Code() int {
	return o._statusCode
}

func (o *ProductServiceGetProductDefault) Error() string {
	return fmt.Sprintf("[POST /v1/product/get][%d] ProductService_GetProduct default  %+v", o._statusCode, o.Payload)
}

func (o *ProductServiceGetProductDefault) String() string {
	return fmt.Sprintf("[POST /v1/product/get][%d] ProductService_GetProduct default  %+v", o._statusCode, o.Payload)
}

func (o *ProductServiceGetProductDefault) GetPayload() *models.GooglerpcStatus {
	return o.Payload
}

func (o *ProductServiceGetProductDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
