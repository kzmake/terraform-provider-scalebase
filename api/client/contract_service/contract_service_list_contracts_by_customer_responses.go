...
func (o *ContractServiceListContractsByCustomerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewContractServiceListContractsByCustomerOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewContractServiceListContractsByCustomerDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewContractServiceListContractsByCustomerOK() *ContractServiceListContractsByCustomerOK {
	return &ContractServiceListContractsByCustomerOK{}
}
...
func (o *ContractServiceListContractsByCustomerOK) Error() string {
	return fmt.Sprintf("[POST /v1/contract/listbycustomer][%d] contractServiceListContractsByCustomerOK  %+v", 200, o.Payload)
}
...
func (o *ContractServiceListContractsByCustomerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewContractServiceListContractsByCustomerDefault(code int) *ContractServiceListContractsByCustomerDefault {
	return &ContractServiceListContractsByCustomerDefault{
		_statusCode: code,
	}
}
...
func (o *ContractServiceListContractsByCustomerDefault) Error() string {
	return fmt.Sprintf("[POST /v1/contract/listbycustomer][%d] ContractService_ListContractsByCustomer default  %+v", o._statusCode, o.Payload)
}
...
func (o *ContractServiceListContractsByCustomerDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
