...
func (o *ContractServiceListContractsOK) Error() string {
	return fmt.Sprintf("[POST /v1/contract/list][%d] contractServiceListContractsOK  %+v", 200, o.Payload)
}
...
func (o *ContractServiceListContractsDefault) Error() string {
	return fmt.Sprintf("[POST /v1/contract/list][%d] ContractService_ListContracts default  %+v", o._statusCode, o.Payload)
}
