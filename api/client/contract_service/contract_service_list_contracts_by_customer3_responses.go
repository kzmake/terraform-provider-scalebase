...
func (o *ContractServiceListContractsByCustomer3Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewContractServiceListContractsByCustomer3OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewContractServiceListContractsByCustomer3Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewContractServiceListContractsByCustomer3OK() *ContractServiceListContractsByCustomer3OK {
	return &ContractServiceListContractsByCustomer3OK{}
}
...
func (o *ContractServiceListContractsByCustomer3OK) Error() string {
	return fmt.Sprintf("[POST /v1/contract/listbycustomerid][%d] contractServiceListContractsByCustomer3OK  %+v", 200, o.Payload)
}
...
func (o *ContractServiceListContractsByCustomer3OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewContractServiceListContractsByCustomer3Default(code int) *ContractServiceListContractsByCustomer3Default {
	return &ContractServiceListContractsByCustomer3Default{
		_statusCode: code,
	}
}
...
func (o *ContractServiceListContractsByCustomer3Default) Error() string {
	return fmt.Sprintf("[POST /v1/contract/listbycustomerid][%d] ContractService_ListContractsByCustomer3 default  %+v", o._statusCode, o.Payload)
}
...
func (o *ContractServiceListContractsByCustomer3Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
