...
func (m *V1ProviderAddress) validateCountry(formats strfmt.Registry) error {
...
func (m *V1ProviderAddress) validatePrefecture(formats strfmt.Registry) error {
