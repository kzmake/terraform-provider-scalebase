...
func (m *ChangeMainItemRequestItemChargeItem) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ChangeMainItemRequestItemChargeItem) validateBillingDueTiming(formats strfmt.Registry) error {
...
func (m *ChangeMainItemRequestItemChargeItem) validateBillingTiming(formats strfmt.Registry) error {
...
func (m *ChangeMainItemRequestItemChargeItem) validateCatalogChargeItemID(formats strfmt.Registry) error {
...
func (m *ChangeMainItemRequestItemChargeItem) contextValidateBillingDueTiming(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ChangeMainItemRequestItemChargeItem) contextValidateBillingTiming(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ChangeMainItemRequestItemChargeItem) UnmarshalBinary(b []byte) error {
	var res ChangeMainItemRequestItemChargeItem
