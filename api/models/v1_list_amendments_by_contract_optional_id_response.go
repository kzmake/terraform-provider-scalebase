...
func (m *V1ListAmendmentsByContractOptionalIDResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1ListAmendmentsByContractOptionalIDResponse) validateAmendments(formats strfmt.Registry) error {
...
func (m *V1ListAmendmentsByContractOptionalIDResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1ListAmendmentsByContractOptionalIDResponse) contextValidateAmendments(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ListAmendmentsByContractOptionalIDResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1ListAmendmentsByContractOptionalIDResponse) UnmarshalBinary(b []byte) error {
	var res V1ListAmendmentsByContractOptionalIDResponse
