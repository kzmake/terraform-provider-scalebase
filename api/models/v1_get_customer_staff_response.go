...
func (m *V1GetCustomerStaffResponse) validateCustomerStaff(formats strfmt.Registry) error {
...
func (m *V1GetCustomerStaffResponse) contextValidateCustomerStaff(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1GetCustomerStaffResponse) UnmarshalBinary(b []byte) error {
	var res V1GetCustomerStaffResponse
