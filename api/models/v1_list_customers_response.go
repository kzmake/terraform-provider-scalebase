...
func (m *V1ListCustomersResponse) validateCustomers(formats strfmt.Registry) error {
...
func (m *V1ListCustomersResponse) contextValidateCustomers(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ListCustomersResponse) UnmarshalBinary(b []byte) error {
	var res V1ListCustomersResponse
