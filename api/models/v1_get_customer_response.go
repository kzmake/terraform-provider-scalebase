...
func (m *V1GetCustomerResponse) validateCustomer(formats strfmt.Registry) error {
...
func (m *V1GetCustomerResponse) contextValidateCustomer(ctx context.Context, formats strfmt.Registry) error {
