...
func (m *V1AddOptionItemRequestChargeItemTiming) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1AddOptionItemRequestChargeItemTiming) validateMonthlyOption(formats strfmt.Registry) error {
...
func (m *V1AddOptionItemRequestChargeItemTiming) validateUnit(formats strfmt.Registry) error {
...
func (m *V1AddOptionItemRequestChargeItemTiming) validateValue(formats strfmt.Registry) error {
...
func (m *V1AddOptionItemRequestChargeItemTiming) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1AddOptionItemRequestChargeItemTiming) contextValidateMonthlyOption(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1AddOptionItemRequestChargeItemTiming) contextValidateUnit(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1AddOptionItemRequestChargeItemTiming) UnmarshalBinary(b []byte) error {
	var res V1AddOptionItemRequestChargeItemTiming
