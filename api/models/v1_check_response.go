...
func (m *V1CheckResponse) validateStatus(formats strfmt.Registry) error {
...
func (m *V1CheckResponse) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
