...
func (m *V1ChangeMainItemResponse) validateContract(formats strfmt.Registry) error {
...
func (m *V1ChangeMainItemResponse) contextValidateContract(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ChangeMainItemResponse) UnmarshalBinary(b []byte) error {
	var res V1ChangeMainItemResponse
