...
func (m *V1ChangeMainItemRequestItem) validateCatalogItemID(formats strfmt.Registry) error {
...
func (m *V1ChangeMainItemRequestItem) validateChargeItems(formats strfmt.Registry) error {
...
func (m *V1ChangeMainItemRequestItem) validateDefaultContractTerm(formats strfmt.Registry) error {
...
func (m *V1ChangeMainItemRequestItem) validateEffectiveStartDate(formats strfmt.Registry) error {
...
func (m *V1ChangeMainItemRequestItem) validateEndDate(formats strfmt.Registry) error {
...
func (m *V1ChangeMainItemRequestItem) contextValidateChargeItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ChangeMainItemRequestItem) UnmarshalBinary(b []byte) error {
	var res V1ChangeMainItemRequestItem
